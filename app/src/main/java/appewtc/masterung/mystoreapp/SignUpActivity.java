...
public class SignUpActivity extends AppCompatActivity {
    ...
    private static final String urlJSON = "http://swiftcodingthai.com/Moo/add_user_master.php";
    ...
    public void clickSignUpSign(View view) {
        ...
        if (checkSpace()) {
            ...
            Toast.makeText(this, "เปลี่ยน User ใหม่ User นี่มีแล้ว", Toast.LENGTH_SHORT).show();
        } else {
            uploadNewUser();
        }
